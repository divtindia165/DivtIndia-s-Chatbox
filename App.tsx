...
import { ChatIcon, ImageIcon, VideoIcon, MicIcon } from './components/common/Icons';

// FIX: Define a global interface for AIStudio to allow for declaration merging and resolve conflicts with other global types.
declare global {
    interface AIStudio {
